        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="ms-auto navbar-nav">
            ...
            <Nav.Link exact to="/create-account" as={NavLink}  className="navbar-link">
              <span onClick={()=>setCurrentLinkHelper("Contratar")} className={current_link=="Contratar"?"secondary-color-span":""}>To Hire</span>
            </Nav.Link>
            ...
            <Nav.Link exact to="/user-account" as={NavLink}  className="navbar-link">
              <span onClick={()=>setCurrentLinkHelper("Cuenta")} className={current_link=="Cuenta"?"secondary-color-span":""}>Account</span>
            </Nav.Link>
            ...
            <Nav.Link href="/" className="navbar-link">
              <span className="secondary-color-span">+91-6263395662</span>
            </Nav.Link>
