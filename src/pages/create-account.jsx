    ...
    <div>
      ...
      <div className="create-account-paragraph-div">
        <p className="create-account-paragraph-p">
          To create an account with new brokers and maintain your information
          updated it is necessary to provide us with a series of required
          documents to create your account so we can negotiate
        </p>
      </div>

      <h4 className="text-center create-account-custom-title">
        Complete this form and you will receive an agreement to start receiving
        loads
      </h4>
          ...
          <div
            ...
            <label className="create-account-label-radio">
              <input
                ...
                defaultChecked={true}
              />
              <span className="create-account-label-radio-span">
                4% Basic Plan
              </span>
            </label>
          ...
          <Row className="create-account-row">
            ...
            <Col xs={12} sm={12} md={6} lg={6} className="create-account-col">
              <div
                ...
                style={{
                  backgroundColor: authority_letter_document
                    ? '#f89422'
                    : 'transparent',
                }}>
                <p
                  ...
                  style={{
                    color: authority_letter_document ? 'white' : '#9d9e9f',
                  }}>
                  AUTHORITY LETTER
                </p>
                <label
              ...
              <div
                className="create-account-upload-file-div"
                style={{
                  backgroundColor: w9_document ? '#f89422' : 'transparent',
                }}>
                <p
                  className="create-account-upload-file-p"
                  style={{ color: w9_document ? 'white' : '#9d9e9f' }}>
                  W9 LETTER
                </p>
                <label
                  for="uploadW9Button"
              ...
              <div
                className="create-account-upload-file-div"
                style={{
                  backgroundColor: insurance_document
                    ? '#f89422'
                    : 'transparent',
                }}>
                <p
                  className="create-account-upload-file-p"
                  style={{ color: insurance_document ? 'white' : '#9d9e9f' }}>
                  INSURANCE
                </p>
                <label
              ...
              <div
                className="create-account-upload-file-div"
                style={{
                  backgroundColor: noa_document ? '#f89422' : 'transparent',
                }}>
                <p
                  className="create-account-upload-file-p"
                  style={{ color: noa_document ? 'white' : '#9d9e9f' }}>
                  NOA (If you have factoring)
                </p>
                <label
                  for="uploadNOAButton"
                  className="create-account-upload-file-label">
